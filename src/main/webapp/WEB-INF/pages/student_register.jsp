...
<div class="col-md-8 col-md-offset-2">
    <div class="page-header"><h2 class="text-center">学生注册</h2></div>
    <form id="stu_register" class="form-horizontal"  method="post" action="#">
        <div class="form-group">
            <label for="studentId" class="col-sm-2 control-label">学号</label>
            <div class="col-sm-10 input-group">
                <span class="input-group-addon iconfont iconxuehao" id="icon_id_id"></span>
                <input type="text" class="form-control form-comp" id="studentId" name="studentId" placeholder="学号" aria-describedby="icon_id_id" style="width: 60%"/>
                <div id="_studentId" style="display: inline-block;"></div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="instructorName" class="col-sm-2 control-label">辅导员姓名</label>
            <div class="col-sm-10 input-group">
                <span class="input-group-addon iconfont iconjiaoshi" id="icon_instructorName_id"></span>
                <input type="text" class="form-control form-comp" id="instructorName" name="instructorName" placeholder="辅导员姓名" aria-describedby="icon_instructorName_id" style="width: 60%"/>
                <div id="_instructorName" style="display: inline-block;"></div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 input-group">
                <span class="input-group-addon iconfont iconchushengnianyue" id="icon_birth_id"></span>
                <input type="text" class="form-control form-comp" id="birth" name="birth" aria-describedby="icon_birth_id" style="width: 60%"/>
                <div id="_birth" style="display: inline-block;"></div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 input-group">
                <span class="input-group-addon iconfont iconxueshenghuaxiang" id="icon_admissionDate_id"></span>
                <input type="text" class="form-control form-comp" id="admissionDate" name="admissionDate" aria-describedby="icon_admissionDate_id" style="width: 60%"/>
                <div id="_admissionDate" style="display: inline-block;"></div>
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="cls" class="col-sm-2 control-label">专业班级</label>
            <div class="col-sm-10 input-group">
                <span class="input-group-addon iconfont iconbanji" id="icon_cls_id"></span>
                <input type="text" class="form-control form-comp" id="cls" name="cls" placeholder="班级" aria-describedby="icon_cls_id" style="width: 60%"/>
                <div id="_fst_cls" style="display: inline-block;"></div>
            </div>
        </div>

        <div class="form-group">
            <label for="dormitoryId" class="col-sm-2 control-label">宿舍号</label>
            <div class="col-sm-10 input-group">
                <span class="input-group-addon iconfont iconshuzi" id="icon_dormitoryId_id"></span>
                <input type="text" class="form-control form-comp" id="dormitoryId" name="dormitoryId" placeholder="宿舍号" aria-describedby="icon_dormitoryId_id" style="width: 60%"/>
                <div id="_dormitoryId" style="display: inline-block;"></div>
            </div>
        </div>

        <div class="form-group">
            <label for="personalPhone" class="col-sm-2 control-label">个人联系电话</label>
            <div class="col-sm-10 input-group">
                <span class="input-group-addon iconfont icondianhua" id="icon_personalPhone_id"></span>
                <input type="text" class="form-control form-comp" id="personalPhone" name="personalPhone" placeholder="个人联系电话" aria-describedby="icon_personalPhone_id" style="width: 60%"/>
                <div id="_personalPhone" style="display: inline-block;"></div>
            </div>
        </div>

        <div class="form-group">
            <label for="parentPhone" class="col-sm-2 control-label">父母联系电话</label>
            <div class="col-sm-10 input-group">
                <span class="input-group-addon iconfont icondianhua" id="icon_parentPhone_id"></span>
                <input type="text" class="form-control form-comp" id="parentPhone" name="parentPhone" placeholder="父母联系电话" aria-describedby="icon_parentPhone_id" style="width: 60%"/>
                <div id="_parentPhone" style="display: inline-block;"></div>
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        setDatepicker('#birth');
        setDatepicker('#admissionDate');
        studentDateValidator("${pageContext.request.contextPath}/stu_id_verify");
        ...
        $('#submit').click(function (e) {
            if ($('#stu_register').data('bootstrapValidator').isValid()) {
